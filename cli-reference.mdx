---
title: "Rewire CLI Reference: All Commands and Flags"
sidebarTitle: "CLI Reference"
description: "Complete reference for every rewire subcommand, flag, and argument — from streaming with record to environment checks with doctor."
---
